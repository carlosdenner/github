...
- visualiza_dados.py: recebe como entrada o arquivo central base de dados e faz análises com suas informações. Gera com saída gráficos em um arquivo html chamado analise_dados.html.
