...
print('Informe o arquivo.json dos repositórios com suas milestones: ')
nome_arquivo = input()
...
for x in range(len(arquivo_json)):
    ...
    registro['quantidade_milestones'] = len(arquivo_json[x]['milestones'])
    arquivo_json_saida.append(registro)

nome_arquivo_saida = f'quantidade-milestones-repositorio.json'
